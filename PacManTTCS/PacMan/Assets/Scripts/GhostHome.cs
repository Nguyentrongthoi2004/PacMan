...
public class GhostHome : GhostBehavior
{
    ...
    private IEnumerator ExitTransition()
    {
        ...
        ghost.movement.rb.bodyType = RigidbodyType2D.Kinematic; // Sửa isKinematic thành bodyType
        ...
        ghost.movement.rb.bodyType = RigidbodyType2D.Dynamic; // Sửa isKinematic thành bodyType
